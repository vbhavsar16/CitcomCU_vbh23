...
struct VISC_OPT
{
  ...
  int proflocy;
  int SMOOTH;				/*whether or not to call apply_viscosity_smoother subfunction. */
  int smooth_loops;			/* number of loops in apply_viscosity_smoother. MAJ 8/8/07*/
  int smooth_cycles;			/* choice in Solver_multigrid */
  ...
  int TSCDEPV;   /* MIB, JAN07 */
  int num_crpmech; /* MIB, JAN07 */
  float V[40], COH[40], d[40]; /* MIB, JAN07; act-vol, water content and grain size */
  float coh_expt[40];  /* MIB, JAN07 */
  float grainsize_expt[40];  /* MIB, JAN07 */
  int YIELD; /* MIB, JAN07 */
  float yield_surf;  /* MIB, JAN07 */
  float yield_mantle; /* MIB, JAN07 */
  float yield_grad; /* MIB, JAN07 */
  float yield_temp; /* MIB, JAN07 */
